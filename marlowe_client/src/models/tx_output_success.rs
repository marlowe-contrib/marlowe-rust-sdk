...
impl TxOutputSuccess {
    ...
    pub fn new(contract: crate::models::Contract, payments: Vec<crate::models::Payment>, state: crate::models::MarloweState, warnings: Vec<crate::models::TransactionWarning>) -> TxOutputSuccess {
        TxOutputSuccess {
