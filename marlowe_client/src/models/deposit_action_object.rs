...
pub struct DepositActionObject {
...
impl DepositActionObject {
    pub fn new(deposits: crate::models::Value, into_account: crate::models::Party, of_token: crate::models::Token, party: crate::models::Party) -> DepositActionObject {
        DepositActionObject {
