...
impl LabelledObjectValue {
    pub fn new(amount_of_token: crate::models::TokenObject, in_account: crate::models::PartyObject, negate: crate::models::ValueObject, add: crate::models::ValueObject, and: crate::models::ObservationObject, minus: crate::models::ValueObject, value: crate::models::ValueObject, multiply: crate::models::ValueObject, times: crate::models::ValueObject, by: crate::models::ValueObject, divide: crate::models::ValueObject, value_of_choice: crate::models::ChoiceIdObject, use_value: String, r#else: crate::models::ContractObject, r#if: crate::models::ObservationObject, then: crate::models::ContractObject, r#ref: String, both: crate::models::ObservationObject, either: crate::models::ObservationObject, or: crate::models::ObservationObject, not: crate::models::ObservationObject, chose_something_for: crate::models::ChoiceIdObject, ge_than: crate::models::ValueObject, gt: crate::models::ValueObject, lt: crate::models::ValueObject, le_than: crate::models::ValueObject, equal_to: crate::models::ValueObject, from_account: crate::models::PartyObject, pay: crate::models::ValueObject, to: crate::models::PayeeObject, token: crate::models::TokenObject, timeout: i64, timeout_continuation: crate::models::ContractObject, when: Vec<crate::models::CaseObject>, be: crate::models::ValueObject, r#let: String, assert: crate::models::ObservationObject, role_token: String, address: String, currency_symbol: String, token_name: String, deposits: crate::models::Value, into_account: crate::models::Party, of_token: crate::models::Token, party: crate::models::Party, choose_between: Vec<crate::models::Bound>, for_choice: crate::models::ChoiceId, notify_if: crate::models::Observation) -> LabelledObjectValue {
        LabelledObjectValue {
