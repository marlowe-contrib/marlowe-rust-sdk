...
pub struct ChoiceContinuationInput {
...
impl ChoiceContinuationInput {
    /// Make a choice in a contract and provide the continuation of the contract
    pub fn new(continuation_hash: String, for_choice_id: crate::models::ChoiceId, input_that_chooses_num: i32, merkleized_continuation: crate::models::Contract) -> ChoiceContinuationInput {
