...
impl NonPositiveDeposit {
    /// A warning for a non-positive deposit.
    pub fn new(asked_to_deposit: i32, in_account: crate::models::Party, of_token: crate::models::Token, party: crate::models::Party) -> NonPositiveDeposit {
        NonPositiveDeposit {
            asked_to_deposit,
