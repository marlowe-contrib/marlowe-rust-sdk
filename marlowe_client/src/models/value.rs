...
impl Value {
    ...
    pub fn new(
        amount_of_token: crate::models::Token,
        in_account: crate::models::Party,
        negate: crate::models::Value,
        add: crate::models::Value,
        and: crate::models::Value,
        minus: crate::models::Value,
        value: crate::models::Value,
        multiply: crate::models::Value,
        times: crate::models::Value,
        by: crate::models::Value,
        divide: crate::models::Value,
        value_of_choice: crate::models::ChoiceId,
        use_value: String,
