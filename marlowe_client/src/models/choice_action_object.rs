...
impl ChoiceActionObject {
    pub fn new(choose_between: Vec<crate::models::Bound>, for_choice: crate::models::ChoiceId) -> ChoiceActionObject {
        ChoiceActionObject {
            choose_between,
