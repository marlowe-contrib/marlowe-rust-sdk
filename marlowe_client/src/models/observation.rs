...
impl Observation {
    ...
    pub fn new(
        and: crate::models::Observation,
        both: crate::models::Observation,
        either: crate::models::Observation,
        or: crate::models::Observation,
        not: crate::models::Observation,
        chose_something_for: crate::models::ChoiceId,
        ge_than: crate::models::Value,
        value: crate::models::Value,
        gt: crate::models::Value,
        lt: crate::models::Value,
        le_than: crate::models::Value,
        equal_to: crate::models::Value,
    ) -> Observation {
        Observation {
            and: Box::new(and),
            both: Box::new(both),
