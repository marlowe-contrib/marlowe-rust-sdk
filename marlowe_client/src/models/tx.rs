...
impl Tx {
    pub fn new(assets: crate::models::Assets, contract_id: String, input_utxo: String, inputs: Vec<crate::models::Input>, invalid_before: String, invalid_hereafter: String, metadata: ::std::collections::HashMap<String, serde_json::Value>, payouts: Vec<crate::models::Payout>, status: crate::models::TxStatus, tags: ::std::collections::HashMap<String, serde_json::Value>, transaction_id: String) -> Tx {
        Tx {
