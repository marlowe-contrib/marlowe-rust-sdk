...
) -> Result<crate::models::ApplyInputsResponse, Error<ApplyInputsToContractError>> {
...
) -> Result<crate::models::CreateContractResponse, Error<CreateContractError>> {
    let local_var_configuration = configuration;
...
) -> Result<crate::models::PostContractSourceResponse, Error<CreateContractSourcesError>> {
    let local_var_configuration = configuration;
...
pub async fn get_contract_by_id(
    configuration: &configuration::Configuration,
    contract_id: &str,
) -> Result<crate::models::GetContractResponse, Error<GetContractByIdError>> {
    let local_var_configuration = configuration;
...
) -> Result<crate::models::ContractSourceIds, Error<GetContractSourceAdjacencyError>> {
    let local_var_configuration = configuration;
...
pub async fn get_contract_source_by_id(
    ...
    contract_source_id: &str,
    expand: Option<bool>,
) -> Result<crate::models::Contract, Error<GetContractSourceByIdError>> {
    let local_var_configuration = configuration;
...
pub async fn get_contract_source_closure(
    configuration: &configuration::Configuration,
    contract_source_id: &str,
) -> Result<crate::models::ContractSourceIds, Error<GetContractSourceClosureError>> {
    let local_var_configuration = configuration;
...
pub async fn get_contract_transaction_by_id(
    ...
    contract_id: &str,
    transaction_id: &str,
) -> Result<crate::models::GetTransactionResponse, Error<GetContractTransactionByIdError>> {
    let local_var_configuration = configuration;
...
pub async fn get_contracts(
    ...
    range: Option<&str>,
) -> Result<crate::models::GetContractsResponse, Error<GetContractsError>> {
    let local_var_configuration = configuration;
...
) -> Result<crate::models::Next, Error<GetNextStepsForContractError>> {
    let local_var_configuration = configuration;
...
pub async fn get_payout_by_id(
    configuration: &configuration::Configuration,
    payout_id: &str,
) -> Result<crate::models::GetPayoutResponse, Error<GetPayoutByIdError>> {
    let local_var_configuration = configuration;
...
pub async fn get_payouts(
    ...
    status: Option<&str>,
    range: Option<&str>,
) -> Result<crate::models::GetPayoutsResponse, Error<GetPayoutsError>> {
    let local_var_configuration = configuration;
...
pub async fn get_transactions_for_contract(
    ...
    contract_id: &str,
    range: Option<&str>,
) -> Result<crate::models::GetTransactionsResponse, Error<GetTransactionsForContractError>> {
    let local_var_configuration = configuration;
...
pub async fn get_withdrawal_by_id(
    configuration: &configuration::Configuration,
    withdrawal_id: &str,
) -> Result<crate::models::Withdrawal, Error<GetWithdrawalByIdError>> {
    let local_var_configuration = configuration;
...
pub async fn submit_contract_transaction(
    ...
    transaction_id: &str,
    text_envelope: Option<crate::models::TextEnvelope>,
) -> Result<(), Error<SubmitContractTransactionError>> {
    let local_var_configuration = configuration;
...
pub async fn submit_withdrawal(
    ...
    withdrawal_id: &str,
    text_envelope: Option<crate::models::TextEnvelope>,
) -> Result<(), Error<SubmitWithdrawalError>> {
    let local_var_configuration = configuration;
...
) -> Result<crate::models::WithdrawPayoutsResponse, Error<WithdrawPayoutsError>> {
    let local_var_configuration = configuration;
