...
pub async fn apply_inputs_to_contract(configuration: &configuration::Configuration, contract_id: &str, x_change_address: &str, x_address: Option<&str>, x_collateral_utx_o: Option<&str>, post_transactions_request: Option<crate::models::PostTransactionsRequest>) -> Result<crate::models::ApplyInputsResponse, Error<ApplyInputsToContractError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ApplyInputsToContractError> = serde_json::from_str(&local_var_content).ok();
...
pub async fn create_contract(configuration: &configuration::Configuration, x_change_address: &str, x_stake_address: Option<&str>, x_address: Option<&str>, x_collateral_utx_o: Option<&str>, post_contracts_request: Option<crate::models::PostContractsRequest>) -> Result<crate::models::CreateContractResponse, Error<CreateContractError>> {
    let local_var_configuration = configuration;
...
pub async fn create_contract_sources(configuration: &configuration::Configuration, main: &str, labelled_object: Option<Vec<crate::models::LabelledObject>>) -> Result<crate::models::PostContractSourceResponse, Error<CreateContractSourcesError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreateContractSourcesError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

pub async fn get_contract_by_id(configuration: &configuration::Configuration, contract_id: &str) -> Result<crate::models::GetContractResponse, Error<GetContractByIdError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetContractByIdError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn get_contract_source_adjacency(configuration: &configuration::Configuration, contract_source_id: &str) -> Result<crate::models::ContractSourceIds, Error<GetContractSourceAdjacencyError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetContractSourceAdjacencyError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

pub async fn get_contract_source_by_id(configuration: &configuration::Configuration, contract_source_id: &str, expand: Option<bool>) -> Result<crate::models::Contract, Error<GetContractSourceByIdError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetContractSourceByIdError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn get_contract_source_closure(configuration: &configuration::Configuration, contract_source_id: &str) -> Result<crate::models::ContractSourceIds, Error<GetContractSourceClosureError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetContractSourceClosureError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

pub async fn get_contract_transaction_by_id(configuration: &configuration::Configuration, contract_id: &str, transaction_id: &str) -> Result<crate::models::GetTransactionResponse, Error<GetContractTransactionByIdError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetContractTransactionByIdError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn get_contracts(configuration: &configuration::Configuration, role_currency: Option<Vec<String>>, tag: Option<Vec<String>>, party_address: Option<Vec<String>>, party_role: Option<Vec<String>>, range: Option<&str>) -> Result<crate::models::GetContractsResponse, Error<GetContractsError>> {
    let local_var_configuration = configuration;
...
pub async fn get_next_steps_for_contract(configuration: &configuration::Configuration, contract_id: &str, validity_start: &str, validity_end: &str, party: Option<Vec<String>>) -> Result<crate::models::Next, Error<GetNextStepsForContractError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetNextStepsForContractError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

pub async fn get_payout_by_id(configuration: &configuration::Configuration, payout_id: &str) -> Result<crate::models::GetPayoutResponse, Error<GetPayoutByIdError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetPayoutByIdError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn get_payouts(configuration: &configuration::Configuration, contract_id: Option<Vec<String>>, role_token: Option<Vec<String>>, status: Option<&str>, range: Option<&str>) -> Result<crate::models::GetPayoutsResponse, Error<GetPayoutsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetPayoutsError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn get_transactions_for_contract(configuration: &configuration::Configuration, contract_id: &str, range: Option<&str>) -> Result<crate::models::GetTransactionsResponse, Error<GetTransactionsForContractError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetTransactionsForContractError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

pub async fn get_withdrawal_by_id(configuration: &configuration::Configuration, withdrawal_id: &str) -> Result<crate::models::Withdrawal, Error<GetWithdrawalByIdError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetWithdrawalByIdError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn get_withdrawals(configuration: &configuration::Configuration, role_currency: Option<Vec<String>>, range: Option<&str>) -> Result<crate::models::GetWithdrawalsResponse, Error<GetWithdrawalsError>> {
    let local_var_configuration = configuration;
...
pub async fn healthcheck(configuration: &configuration::Configuration, ) -> Result<(), Error<HealthcheckError>> {
    let local_var_configuration = configuration;
...
pub async fn submit_contract(configuration: &configuration::Configuration, contract_id: &str, text_envelope: Option<crate::models::TextEnvelope>) -> Result<(), Error<SubmitContractError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SubmitContractError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn submit_contract_transaction(configuration: &configuration::Configuration, contract_id: &str, transaction_id: &str, text_envelope: Option<crate::models::TextEnvelope>) -> Result<(), Error<SubmitContractTransactionError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SubmitContractTransactionError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn submit_withdrawal(configuration: &configuration::Configuration, withdrawal_id: &str, text_envelope: Option<crate::models::TextEnvelope>) -> Result<(), Error<SubmitWithdrawalError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SubmitWithdrawalError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn withdraw_payouts(configuration: &configuration::Configuration, x_change_address: &str, x_address: Option<&str>, x_collateral_utx_o: Option<&str>, post_withdrawals_request: Option<crate::models::PostWithdrawalsRequest>) -> Result<crate::models::WithdrawPayoutsResponse, Error<WithdrawPayoutsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<WithdrawPayoutsError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
